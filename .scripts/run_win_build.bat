...
powershell -NoProfile -ExecutionPolicy Bypass "$ErrorActionPreference='Stop'; Set-StrictMode -Version Latest; $BinDir=Join-Path $Env:USERPROFILE '.pixi\bin'; $TEMP_FILE=[System.IO.Path]::GetTempFileName(); Write-Host 'Invoking download-only'; Invoke-WebRequest -Uri 'https://github.com/prefix-dev/pixi/releases/latest/download/pixi-x86_64-pc-windows-msvc.zip'"
powershell -NoProfile -ExecutionPolicy Bypass "$ErrorActionPreference='Stop'; Set-StrictMode -Version Latest; $BinDir=Join-Path $Env:USERPROFILE '.pixi\bin'; $TEMP_FILE=[System.IO.Path]::GetTempFileName(); Write-Host 'Invoking download and write to outfile'; Invoke-WebRequest -Uri 'https://github.com/prefix-dev/pixi/releases/latest/download/pixi-x86_64-pc-windows-msvc.zip' -OutFile $TEMP_FILE"
