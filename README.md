...
Once the `conda-forge` channel has been enabled, `openfoam` can be installed with:

```
conda install openfoam
```

It is possible to list all of the versions of `openfoam` available on your platform with:
