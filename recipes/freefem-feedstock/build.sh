...
./configure --prefix=$PREFIX \
            ...
            --disable-tetgen --disable-lapack --disable-metis --disable-parmetis --disable-mmg3d --disable-mmg --disable-parmmg --disable-mshmet --disable-gmm --disable-mumps --disable-mumps_seq --disable-nlopt --disable-scotch --disable-umfpack --disable-yams --disable-pipe --disable-libpthread_google --disable-MMAP --disable-NewSolver --disable-mkl --disable-hpddm --disable-bem \
