...
This test is copied from https://github.com/conda-forge/firefox-feedstock
It's rather pointless when we only have linux package as firefox won't
run on conda-forge build infrastructure see
https://github.com/conda-forge/staged-recipes/issues/9314
for more details.

But will be useful when we add future versions.
"""
import sys
import os
import subprocess
