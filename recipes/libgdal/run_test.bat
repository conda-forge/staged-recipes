...
rem  :: Test ISIS3/USGS driver `SetNoDataValue()` issue.
rem  gdalinfo cropped.cub
rem  
rem  :: From @akorosov. See https://github.com/conda-forge/gdal-feedstock/issues/83
rem  gdalinfo /vsizip/stere.zip/stere.tif
rem  
rem  :: Check shapefile read.
rem  ogrinfo sites.shp
