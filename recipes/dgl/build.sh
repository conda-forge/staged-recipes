...
cmake -DUSE_CUDA=ON \
  ...
  -DUSE_EXTERNAL_THRUST=OFF \
  -DUSE_EXTERNAL_DLPACK=ON \
  -DEXTERNAL_DLPACK_PATH=$PREFIX/include \
  -DUSE_EXTERNAL_DMLC=ON \
  -DEXTERNAL_DMLC_PATH=$PREFIX/include \
  -DUSE_EXTERNAL_METIS=OFF \
  -DUSE_EXTERNAL_PHMAP=ON \
  -DEXTERNAL_PHMAP_PATH=$PREFIX/include \
  -DUSE_EXTERNAL_XBYAK=ON \
  -DEXTERNAL_XBYAK_PATH=$PREFIX/include \
  -DUSE_EXTERNAL_NANOFLANN=ON \
