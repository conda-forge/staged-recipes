...
export LIBRARY_PATH="$BUILD_PREFIX/x86_64-conda-linux-gnu/sysroot/usr/lib:$BUILD_PREFIX/lib:$LIBRARY_PATH"
export LD_LIBRARY_PATH="$BUILD_PREFIX/x86_64-conda-linux-gnu/sysroot/usr/lib:$BUILD_PREFIX/lib:$LD_LIBRARY_PATH"
