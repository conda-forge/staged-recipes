...
bazel build -s --verbose_failures --define=PROTOBUF_INCLUDE_PATH=${PREFIX}/include --define=PREFIX=${PREFIX} $BAZEL_OPTIMIZATION //tensorflow_io/... //tensorflow_io_gcs_filesystem/...
