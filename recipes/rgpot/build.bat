...
REM llvm-ar wraps them in GNU archives (LNK1107). Force MSVC lib.exe.
set "AR=lib"
...
REM (OmniPotentRPC/rgpot#61). Fortran pots: AR=lib as above.
REM MESON_ARGS already sets buildtype/prefix/libdir.
meson setup builddir %MESON_ARGS% -Dwith_rpc=true -Dwith_fortran_pots=enabled -Dwith_eigen=true -Dpure_lib=false -Dwith_cache=false -Dwith_tests=false -Dwith_examples=false
