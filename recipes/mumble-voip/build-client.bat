@echo off
:: Build script for mumble-client on Windows
...
mkdir "%PREFIX%\share\licenses\mumble-client"
copy "%SRC_DIR%\src\mumble\LICENSE" "%PREFIX%\share\licenses\mumble-client\LICENSE"
if exist "%SRC_DIR%\src\mumble\3rdPartyLicenses" (
    xcopy /s /e /i "%SRC_DIR%\src\mumble\3rdPartyLicenses" "%PREFIX%\share\licenses\mumble-client\3rdPartyLicenses"
)
