...
call gradlew.bat :sirius_dist:sirius_gui_multi_os:installDist -P "build.sirius.location.lib=..\share\%packageName%\lib" -P "build.sirius.native.remove.linux=true" -P "build.sirius.native.remove.mac=true" -P "build.sirius.starter.remove.ix=true"
