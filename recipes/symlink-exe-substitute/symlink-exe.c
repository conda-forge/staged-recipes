...
*/
    ...
    #error "RELATIVE_PATH must be defined, e.g., Library\\bundle\\bin"
#endif
...
int run(int argc, char **argv, int is_gui)
{
    ...
    char *fn, *end, *ext, *relative_path;     /* working pointers for string manipulation */
    char *cmdline;
    int i;              /* loop counter */
    ...
    */
    ...
    while (strncmp(relative_path, "..\\", 3) == 0) {
        relative_path += 3;
        while (end > path) {
            end--;
            if (*end == '\\') {
