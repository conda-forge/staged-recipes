...
def common_tests_for_core_and_mcxtrace_pkgs( take_instr_file_from_src ):
    ...
    if platform.system().lower()=='windows':
        ensure_files_are_installed( [
            ...
            'share/mcxtrace/resources/examples/SAXSLAB/SAXS_saxlab/SAXS_saxlab.instr',
        ] )
...
def tests_for_pkg_mcxtrace():
    ...
    #run_instrument_file( 'share/mcxtrace/resources/examples/SAXSLAB/SAXS_saxlab/SAXS_saxlab.instr', 'Energy=8.05 -s1000 -n1e5 --mpi=2')
