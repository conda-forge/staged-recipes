...
cmake -S "%SRC_DIR%" -B build -DPython3_EXECUTABLE="%PYTHON%" -G "MinGW Makefiles" -DFABM_EXTRA_INSTITUTES=ogs -DFABM_OSG_BASE="%PREFIX%\extern\ogs" -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX="%PREFIX%" %CMAKE_ARGS%
