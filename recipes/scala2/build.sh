...
sbt dist/mkPack makePom

mkdir -p ${SRC_DIR}/target/generated-resources/licenses
# pom_file=$(find -name dist-${PKG_VERSION}-bin-SNAPSHOT.pom)
filename=scala-dist-${PKG_VERSION}-bin-SNAPSHOT.pom
