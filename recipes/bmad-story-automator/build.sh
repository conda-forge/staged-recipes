...
# Mirror upstream's `files` array in package.json:
#   bin/, docs/, install.sh, skills/, README.md, ref.png, .claude-plugin/
# Plus package.json + LICENSE for runtime version lookup and licence shipping.
