...
find bazel-tensorflow/tensorflow/cc -name "*.cc" -type f -delete
find bazel-tensorflow/tensorflow/core -name "*.cc" -type f -delete
find bazel-tensorflow/third_party -name "*.cc" -type f -delete

# copy includes
mkdir -p ${PREFIX}/include/tensorflow
cp -r bazel-genfiles/* ${PREFIX}/include/
cp -r bazel-tensorflow/tensorflow/cc ${PREFIX}/include/tensorflow
cp -r bazel-tensorflow/tensorflow/core ${PREFIX}/include/tensorflow
cp -r bazel-tensorflow/third_party ${PREFIX}/include
