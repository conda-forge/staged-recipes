...
make CXX=%CXX% CXXFLAGS='-std=c++11 -O3 -mfpmath=sse -msse -msse2 -msse3 -DEVIDENCE_SR -DEVIDENCE_PARS -DNDEBUG -Wundef -Winline --param large-function-growth=100000 -Wall'
