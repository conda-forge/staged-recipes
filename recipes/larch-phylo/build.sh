...
MAKE_NUM_THREADS=${MAKE_NUM_THREADS:-"8"}
...
echo "=== BEGIN CMAKE STEP ==="
cmake --verbose -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DUSE_USHER=${CMAKE_USE_USHER} ..
echo "=== BEGIN MAKE STEP ==="
